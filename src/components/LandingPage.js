...
import modileAppsIcon from '../assets/mobileIcon.svg';
        ...
        <Grid container justify="flex-end" alignItems="center" direction="row">
          <Grid sm item className={classes.heroTextContainer}>
            <Typography variant="h2" align="center" >
              Learning React and Material-UI<br /> to get Git-R-Done!
            </Typography>
            <Grid container justify="center"className={classes.buttonConatiner}>
              <Grid item>
                <Button classNmae={classes.estimateButton} variant="contained"> Free Estimate</Button>
              </Grid>
              <Grid item>
      ...
      className={classes.servicesContainer}>
        <Grid item style={{marginLeft: matchesSM ? 0 : "5em", textAlign: matchesSM ? "center" : undefined}}>
          ...
          <Typography variant="subtitle1" className={classes.subtitle}>
            ...
            <span className={classes.specialText}>Celebrateion.</span>
          </Typography>
          <Button variant="outlined" className={classes.leanButton}>
          Learn More
    ...
    <Grid item> {/*-----iOS/Anroid Block-----*/}
      ...
      className={classes.servicesContainer}>
        ...
        <Grid item style={{marginRight: matchesSM ? 0 : "5em"}}>
          <img className={classes.icon} alt="mobile phone icon" src={modileAppsIcon} />
        </Grid>
      </Grid>
    </Grid>
